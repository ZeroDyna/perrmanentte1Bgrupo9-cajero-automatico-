...
while True:
    ...
    #Operación retirar saldo
        ...
        while True:
            ...
            try:
                seleccion = int(input("\nIngrese el número de la opción correspondiente a la cantidad que desea retirar: "))
            ...
            #Si el ususario desea retirar otra cantidad
                ...
                while True:
                    ...
                    #La cantidad deseada no puede tener más de 2 decimales
                    if cantidad_deseada * 100 % 1 != 0:
            ...
            if cantidad_deseada > saldo:
                ...
                print("\nLa cantidad ingresada es mayor a su saldo actual(S/{:.2f}). Ingrese otra cantidad.".format(saldo))
                continue
                ...
                while True:
                    ...
                    if seleccion == "1":
                        print("\nSu saldo actual es de: S/{:.2f}".format(saldo))
                        break
                    elif seleccion == "2":
